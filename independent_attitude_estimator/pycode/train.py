...
class Trainer:
    ...
    def getOptimizer(self, optimizer_name, lr_resnet, lr_roll_fc, lr_pitch_fc, weight_decay):
        if self.multiGPU == 1 and self.device == 'cuda':
            list_resnet_mono_param_value, list_resnet_depth_param_value, list_roll_fc_param_value, list_pitch_fc_param_value = self.net.module.getParamValueList()
        elif self.multiGPU == 0:
            list_resnet_mono_param_value, list_resnet_depth_param_value, list_roll_fc_param_value, list_pitch_fc_param_value = self.net.getParamValueList()

        if optimizer_name == "SGD":
            optimizer = optim.SGD([
                {"params": list_resnet_mono_param_value, "lr": lr_resnet},
                {"params": list_resnet_depth_param_value, "lr": lr_resnet},
